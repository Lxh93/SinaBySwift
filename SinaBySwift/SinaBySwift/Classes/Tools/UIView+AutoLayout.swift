    ...
    func layoutAttributes(isInner: Bool, isVertical: Bool) -> XMG_LayoutAttributes {
        ...
        switch self {
            case .topLeft:
                ...
                let _ = attributes.horizontals(from: .left, to: .left).verticals(from: .top, to: .top)
                if isInner {
                    return attributes
                } else if isVertical {
            ...
            case .topRight:
                let _ = attributes.horizontals(from: .right, to: .right).verticals(from: .top, to: .top)
            ...
            case .bottomLeft:
                let _ = attributes.horizontals(from: .left, to: .left).verticals(from: .bottom, to: .bottom)
            ...
            case .bottomRight:
                let _ = attributes.horizontals(from: .right, to: .right).verticals(from: .bottom, to: .bottom)
            ...
            // 仅内部 & 垂直参照需要
            case .topCenter:
                let _ = attributes.horizontals(from: .centerX, to: .centerX).verticals(from: .top, to: .top)
                return isInner ? attributes : attributes.verticals(from: .bottom, to: .top)
            // 仅内部 & 垂直参照需要
            case .bottomCenter:
                let _ = attributes.horizontals(from:.centerX, to: .centerX).verticals(from: .bottom, to: .bottom)
                return isInner ? attributes : attributes.verticals(from: .top, to: .bottom)
            // 仅内部 & 水平参照需要
            case .centerLeft:
                let _ = attributes.horizontals(from: .left, to: .left).verticals(from: .centerY, to: .centerY)
                return isInner ? attributes : attributes.horizontals(from: .right, to: .left)
            // 仅内部 & 水平参照需要
            case .centerRight:
                let _ = attributes.horizontals(from: .right, to: .right).verticals(from: .centerY, to: .centerY)
...
extension UIView {
    ...
    :returns: 约束数组
    */
    public func xmg_Fill(referView: UIView, insets: UIEdgeInsets) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignInner(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint]  {
        
//        return xmg_AlignLayout(referView: referView, attributes: type.layoutAttributes(true, isVertical: true), size: size, offset: offset)
    ...
    :returns: 约束数组
    */
    public func xmg_AlignVertical(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func xmg_AlignHorizontal(type: XMG_AlignType, referView: UIView, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
    ...
    */
    public func xmg_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        let _ = firstView.xmg_AlignInner(type: XMG_AlignType.topLeft, referView: self, size: nil, offset: CGPoint(x: insets.left, y: insets.top))
        ...
        for i in 1..<views.count {
            ...
            let _ = subView.xmg_AlignHorizontal(type: XMG_AlignType.topRight, referView: preView, size: nil, offset: CGPoint(x: insets.right, y: 0))
            preView = subView
        }
    ...
    */
    public func xmg_VerticalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.xmg_sizeConstraints(referView:firstView)
           let _ = subView.xmg_AlignVertical(type: XMG_AlignType.bottomLeft, referView: preView, size: nil, offset: CGPoint(x: 0, y: insets.bottom))
            preView = subView
        }
    ...
    */
    ...
    :returns: 约束数组
    */
    func xmg_sizeConstraints(size: CGSize) -> [NSLayoutConstraint] {
